...
<html>
  <head>
    <title>Ceap International</title>
    <link rel="stylesheet" href="../Users/UNITECH/Documents/Unnamed Site 5/app.css">
    <script src="../Users/UNITECH/Documents/Unnamed Site 5/app.js"></script>
<link rel="icon" type="image/ico" href="../Users/UNITECH/Documents/Unnamed Site 5/favicon.ico">
<link rel="stylesheet" type="text/css" href="https://www.9kw.eu/style/style.css" />
<link rel="shortcut icon" href="../Users/UNITECH/Documents/Unnamed Site 5/favicon.ico" type="image/x-icon">
<link rel="icon" href="../Users/UNITECH/Documents/Unnamed Site 5/favicon.ico" type="image/x-icon">
<link type="text/css" href="https://www.9kw.eu/grafik/css/jquery.ui/jquery-ui.css" rel="stylesheet" />
<script type="text/javascript" src="https://www.9kw.eu/grafik/js/jquery.1.9.1.min.js"></script>
<script type="text/javascript" src="https://www.9kw.eu/grafik/js/jquery-ui.min.js"></script>
<link rel="stylesheet" href="https://www.9kw.eu/grafik/jquery.tabs.css" type="text/css" media="print, projection, screen">
<style>
.alert
{
    font-size: 1.3em;
...
<body>
<script type="text/javascript" src="https://www.9kw.eu/grafik/js/jquery.rotate.js"></script>
<style>
.greyscale_filter {
	filter: gray;
}
...
<script src="https://www.9kw.eu/grafik/js/jquery.rotate.js"></script>
<script src="https://www.9kw.eu/grafik/js/jquery.greyscale.js"></script>
<script src="https://www.9kw.eu/grafik/js/jquery.css-transform.js"></script>
<script src="https://www.9kw.eu/grafik/js/jquery.rotate3Di.js"></script>
<script src="https://www.9kw.eu/grafik/js/jquery.iframer.js"></script>
<script src="https://www.9kw.eu/grafik/js/jquery.base64.min.js"></script>

<span style="display:none;">
<audio id="nextsoundplay" controls="controls" preload="auto">
	<source src="https://www.9kw.eu/grafik/test.ogg">
</audio>
</span>

<style>
.plugintab { padding: 1; clear: both; margin: 0px;}
.plugintab ul ol { list-style-type: none; }
.plugintab ol {
	display: inline;
	background: none;
	margin: 0px;
...
.plugintab ol a {
	...
	padding: 7px;
	float: left;
	border-right: 3px solid #F5F5EE;
	border-bottom: none;
	text-decoration: underline;
	color: #FFF;
	font-weight: bold;
}
.plugintab ol.active a { background: #323534; color: white; }

.draggable {cursor: move;position: absolute; padding: 0em; margin: 0 0px 0px 0; }
#containment-wrapper { width: 450px; height:160px; border:2px solid #ccc; padding: 0px; }
					...
					if(statuscaptcha[key] == 0 && captchaid == "" && captchas[key].captchaid.match(/^\d+$/)){
						...
						if(captchas[key].text == 1){
							...
							if(interactive_ok == 1){
								...
								var rcv2_js = "<"+rcv2_js_new+" src='https://www.google.com/recaptcha/api.js?hl=en' async defer></"+rcv2_js_new+">";
								var preselect = "image";
								...
								if(captchas[key].oldsource == "funcaptcha"){
									rcv2_thing1 = '<form action="http://127.0.0.1:12345/save/funcaptcha" name="myForm" id="myForm" method="post">';
									...
									success: function(data, textStatus, request){
										if(request.status == 200){
											if(newpageurl.match("https://") || newpageurl.match("http://")){
												$("#interactivecaptchahtml").html("<span style=\"position:absolute;display: inline-block;overflow:visible;height: 200px;\"><iframe nwdisable nwfaketop"+newuseragent+" frameborder=\"0\" scrolling=\"no\" src=\""+newpageurl+"\" width=\""+$("#widthc").val()+"\" height=\""+$("#heightc").val()+"\"></iframe></span>");
											}else if(newpageurl.length > 5){
												$("#interactivecaptchahtml").html("<span style=\"position:absolute;display: inline-block;overflow:visible;height: 200px;\"><iframe nwdisable nwfaketop"+newuseragent+" frameborder=\"0\" scrolling=\"no\" src=\"http://"+newpageurl+"\" width=\""+$("#widthc").val()+"\" height=\""+$("#heightc").val()+"\"></iframe></span>");
											}else{
												$("#interactivecaptchahtml").html("<span style=\"position:absolute;display: inline-block;overflow:visible;height: 200px;\"><iframe nwdisable nwfaketop"+newuseragent+" frameborder=\"0\" scrolling=\"no\" src=\"http://127.0.0.1:12345/\" width=\""+$("#widthc").val()+"\" height=\""+$("#heightc").val()+"\"></iframe></span>");
											}
										}
									}
								});
...
<table border="0" style="margin: 0px;">
	<td>
		<h1 style="display: inline;">Captcha</h1>
	</td>
	<td>
		<span id="captchachars" style="background-color:#7aca97;font-size: 14px; color: #000000; text-decoration: none;padding:7px;font-weight: bold;display:none;">A-Z, 0-9</span>
		<span id="captchalength" style="background-color:#7aca97;font-size: 14px; color: #000000; text-decoration: none;padding:7px;font-weight: bold;display:none;">1-50</span>
		<span id="captchatype" style="background-color:#7aca97;font-size: 14px; color: #000000; text-decoration: none;padding:7px;font-weight: bold;display:none;">Text</span>
		<span id="captchacase" style="background-color:#7aca97;font-size: 14px; color: #000000; text-decoration: none;padding:7px;font-weight: bold;display:none;">cAsE</span>
		<span id="captchamath" style="background-color:#7aca97;font-size: 14px; color: #000000; text-decoration: none;padding:7px;font-weight: bold;display:none;">Mathe 1+1=2</span>
		<span id="captchanospace" style="background-color:#7aca97;font-size: 14px; color: #000000; text-decoration: none;padding:7px;font-weight: bold;display:none;">Kein Leerzeichen</span>
		<span id="captchaphrase" style="background-color:#7aca97;font-size: 14px; color: #000000; text-decoration: none;padding:7px;font-weight: bold;display:none;">2+ W&ouml;rter</span>
		<span id="captchasandbox" style="background-color:#7aca97;font-size: 14px; color: #000000; text-decoration: none;padding:7px;font-weight: bold;display:none;">Sandbox</span>
		Apikey: <input type="text" id="apikey" name="apikey" onchange="showcaptchasave();" size="25" value="__apikey__"> <span id="newupdate" style="display:none;color: red;font-weight: bold;">NEW 9kw client update is available!</span>
	</td>
</table>

<input type="hidden" name="idcaptcha" id="idcaptcha" value="">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
     <td width="455">
	<span id="mycaptcha"></span> <span id="captchaidsize"></span>
	<span id="emptything" style="display: none;"><br>Please use 0 as "Empty" answer!</span>
	</td>
     <td width="215">
<ul id="plugintab1" class="plugintab">
	<ol><a onclick="$('#userhistory').show();$('#usertop').hide();$('#userlog').hide();" style="cursor: pointer; cursor: hand;" id="historyname">History</a></ol>
	<ol><a onclick="$('#userhistory').hide();$('#usertop').hide();$('#userlog').show();" style="cursor: pointer; cursor: hand;" id="logname">Log</a></ol>
</ul>

</td>
    </tr>
    <tr>
     <td width="455" height="350" valign="top">
		<input type="button" id="captchaskipinteractive" title="Skip" value="SKIP" style="display: none;">
		<div id="usercaptchaget">Sleep mode is active for your account.<br>Please click on start to continue!
		<br><br>
- Solve swiftly and precisely<br>
- Write correctly. Answers are case-sensitive<br>
- Do not enter nonsense<br>
- Use skip if really necessary. (Button skip or press ESC)<br>
- Don't use shady methods for solutions<br>
<br>

		</div>
		<div id="textthing" style="display: none;"></div>
		<div id="usercaptchatext" style="display: none;"></div>
		<div id="progressbar2" style="display: none;" class="ui-progressbar-overlay"></div>
		<span id="imagecaptchahtml" style="display: none;"></span>
		<span id="audiocaptchahtml" style="display: none;"></span>
		<span id="interactivecaptchahtml" style="display: none;"><iframe src="" id="interactiveiframe" frameborder="0" scrolling="auto" class="iframe-full-height"></iframe></span>
		<span id="puzzlecaptchahtml" style="display: none;">
		<div id="containment-wrapper">
		  <img src="" id="sampleimg">
		  <div id="draggable1" class="draggable ui-widget-content"><img src="" id="draggable1img"></div>
		  <div id="draggable2" class="draggable ui-widget-content"><img src="" id="draggable2img"></div>
		  <div id="draggable3" class="draggable ui-widget-content"><img src="" id="draggable3img"></div>
		  <div id="draggable4" class="draggable ui-widget-content"><img src="" id="draggable4img"></div>
		  <div id="draggable5" class="draggable ui-widget-content"><img src="" id="draggable5img"></div>
		  <div id="draggable6" class="draggable ui-widget-content"><img src="" id="draggable6img"></div>
		</div>
		</span>
	</td>
     <td width="215" valign="top" rowspan="2">
	<!-- NOAPP --><div id="userhistory" style="width:222px; height:168px;overflow:auto;"></div><div id="usertop" style="width:222px; height:168px;overflow:auto;display: none;"></div><div id="userlog" style="width:222px; height:168px;overflow:auto;display: none;">No entry</div><!-- NOAPP -->
		<fieldset style="float: left; padding: 5px; margin-top: 10px">
			<legend> Notification </legend>
		<span title="Sound by new captcha."><input type="checkbox" name="sound" id="sound" value="1" __sound__> Sound </span><br>
<!--		<span title="Popup by new captcha."><input type="checkbox" name="popup" id="popup" value="1" __popup__> Popup </span><br>-->
		<span title="Notification by new captcha for firefox or chrome."><input type="checkbox" name="desktopinfo" id="desktopinfo" value="1" __desktop__> Desktop</span><br>
		<span title="Updates the small history, credit and statistics every few seconds."><input type="checkbox" id="refresh" name="refresh" value="1" __refresh__> Refresh</span><br>

		<input type="checkbox" id="autostart" value="1" __autostart__> Autostart<br>
		<span title="The option Speed assigns a new captcha while the previous one is still being solved, the time available for solving can be significantly reduced as a result.">
		<input type="checkbox" name="speed" id="speed" value="1" __speed__> Speed 
		<select name="speedlevel" id="speedlevel" size="1">
		<option value="0" __speedlevel0__>0</option>
		<option value="1" __speedlevel1__>1</option>
		<option value="2" __speedlevel2__>2</option>
		<option value="3" __speedlevel3__>3</option>
		</select>
		</span><br>
		<input type="checkbox" id="grau" value="1" __grau__> Grayscale<br>
		<br>

		<input type="button" id="captchastart" value="Start"> 
		<input type="button" id="captchastop" value="Stop">
		</fieldset>

		<fieldset style="float: left; padding: 5px; margin-top: 10px">
			<legend> Typ </legend>
			<input type="checkbox" id="textcaptcha" value="1" __textcaptcha__> Image (Text) <br>
			<input type="checkbox" id="mousecaptcha" value="1" __mousecaptcha__> Mouse <br>
			<input type="checkbox" id="multimousecaptcha" value="1" __multimousecaptcha__> Multimouse <br>
			<input type="checkbox" id="audiocaptcha" value="1" __audiocaptcha__> Audio <br>
			<input type="checkbox" id="rotatecaptcha" value="1" __rotatecaptcha__> Rotate <br>
			<input type="checkbox" id="puzzlecaptcha" value="1" __puzzlecaptcha__> Puzzle <br>
			<input type="checkbox" id="textonlycaptcha" value="1" __textonlycaptcha__>  Textonly <br>
			<input type="checkbox" id="confirmcaptcha" value="1" __confirmcaptcha__> Confirm <br>
			<input type="checkbox" id="interactivecaptcha" value="1" __interactivecaptcha__> Interactive 
		</fieldset>
		<br>
	</td>
    </tr>
...
<span id="confirmcaptchahtml" style="display: none;">Data: <span id="confirmcaptchadata"></span><br> <input type="button" id="captchatrue" style="background-color:#00FF00;width:115px;height:40px;" value="Correct"> <input type="button" id="captchafalse" style="background-color:#FF3333;width:115px;height:40px;" value="Wrong"><br><br></span>

	<input type="text" id="input_text" size="35" value="" autocomplete="off" autofocus required> 
	<span id="captchasend">
		<input type="button" id="captchasend1" title="Send" value="OK"> 
		<input type="button" id="captchasend2" title="Send and stop" value="OK+Stop"> 
	</span>

	<input type="button" id="captchasendempty" style="display: none;" value="Empty"> 
	<input type="button" id="captchaskip" title="Skip" value="SKIP"> <br>
Zoom: <select id="zoomdata">
<option value="100" __zoom100__>-</option>
<option value="105" __zoom105__>+</option>
<option value="110" __zoom110__>++</option>
<option value="115" __zoom115__>+++</option>
<option value="120" __zoom120__>++++</option>
<option value="125" __zoom125__>+++++</option>

</select> 
Options: <input type="checkbox" id="flip" value="1" __flip__> Flip 
<input type="checkbox" id="mirror" value="1" __mirror__> Mirror 
	</td>
    </tr>
    <tr>
      <td>
		...
		<br><br>
		<div id="timertimebad"></div>
		<div id="guthaben"></div>
		<div id="useronline_header"></div>
		<div id="newuser24h_header"></div>
		<div id="missedcaptcha_header"></div>
	</td>
    </tr>
   </table>
...
<table width="100%" border="0" style="margin: 0px;">
	<td width="67%">
<b>Legend:</b><br>
<font color=00FF00>OK</font> (green): Captcha feedback all right<br>
<font color=FF3333>Not</font> (red): Captcha feedback not all right<br>
? (black): Feedback not available yet<br>
	</td>
	<td>
		Interactive captcha size:<br>
		<input type="text" size="2" id="widthc" value="550"> x <input type="text" size="2" id="heightc" value="500"><br>
		Preconfig for recaptcha v2: <input type="checkbox" name="rc2pre" value="1" id="rc2audio" __rc2audio__> Audio<br>
		Startconfig: <input type="checkbox" name="startpre" value="2" id="startpre" __startpre__> Standard (Restart required)<br>
	</td>
</table>
